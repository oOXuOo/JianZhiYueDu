...
Item {
    ...
    Flickable{
        ...
        contentHeight: 20+logo_on_top.height+description1.contentHeight+description2.contentHeight+author_pic.height
        Image{
            id: logo_on_top
...
<p>热爱阅读，热爱人生，热爱简致！<br>欢迎访问我们的网站<br><a href='http://www.jianzhiyuedu.com'>http://www.jianzhiyuedu.com</a></p></div>"
        }
        Image{
            id: author_pic
        ...
        Text{
            ...
            font.pointSize: 18
            color: "black"
            text: "<div><p>黝～～，我是oOXuOo，简致阅读的发起者之一，也是Android，iOS客户端的作者，同时负责后端的文章采集和文章源的控制。</p>
<p>喜欢开源技术，喜欢精美文章，如果你对移动版本感兴趣，可以在GitHub上找到源码哦。<br><a href='https://github.com/oOXuOo/JianZhiYueDu'>https://github.com/oOXuOo/JianZhiYueDu</a></p></div>"
        }
    }
}
